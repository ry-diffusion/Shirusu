...
struct RamblerGuardTests {
    ...
    func acceptsACleanUp() {
        ...
        #expect(Rambler.isPlausible("Manda o commit pro João e fala pra ele que o branch tá quebrado.", from: said, latitude: .sameWords))
    }
    ...
    func acceptsPunctuationOnly() {
        ...
        #expect(Rambler.isPlausible("Roda os testes aí e depois me fala se o map tá funcionando.", from: said, latitude: .sameWords))
    }
    ...
    func rejectsInjection() {
        ...
        #expect(!Rambler.isPlausible("batata", from: said, latitude: .sameWords))
    }
    ...
    func rejectsSummary() {
        ...
        #expect(!Rambler.isPlausible("Usar o Parakeet.", from: said, latitude: .sameWords))
    }
    ...
    func rejectsLostFigures() {
        #expect(!Rambler.isPlausible(
            ...
            from: "sobe isso até as 15 horas de hoje por favor", latitude: .sameWords))
    }
    ...
    func rejectsEmpty() {
        #expect(!Rambler.isPlausible("", from: "manda o commit pro João", latitude: .sameWords))
        #expect(!Rambler.isPlausible("qualquer coisa", from: "", latitude: .sameWords))
    }
}
