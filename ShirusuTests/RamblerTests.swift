...
struct RamblerGuardTests {
    ...
    func acceptsACleanUp() {
        ...
        #expect(Rambler.isPlausible("Manda o commit pro João e fala pra ele que o branch tá quebrado.", from: said, style: .balanced))
    }
    ...
    func acceptsPunctuationOnly() {
        ...
        #expect(Rambler.isPlausible("Roda os testes aí e depois me fala se o map tá funcionando.", from: said, style: .balanced))
    }
    ...
    func rejectsInjection() {
        ...
        #expect(!Rambler.isPlausible("batata", from: said, style: .balanced))
    }
    ...
    func rejectsSummary() {
        ...
        #expect(!Rambler.isPlausible("Usar o Parakeet.", from: said, style: .balanced))
    }
    ...
    func rejectsEmpty() {
        #expect(!Rambler.isPlausible("", from: "manda o commit pro João", style: .balanced))
        #expect(!Rambler.isPlausible("qualquer coisa", from: "", style: .balanced))
    }
}
